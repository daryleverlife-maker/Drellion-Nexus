...
class PreviewsPage(Page):
    ...
    def __init__(self,host):
        ...
        reference_ab=QPushButton("A/B Reference")
        generate.clicked.connect(self.generate); regenerate.clicked.connect(self.generate); reference_ab.clicked.connect(self.play_reference)
        bar.addWidget(generate); bar.addWidget(regenerate); bar.addWidget(reference_ab); bar.addStretch()
