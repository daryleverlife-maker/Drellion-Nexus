...
def _bar_template(bpm: float, variant: int, chord_index: int, tonic_midi: int) -> array:
    ...
    # Original minor-mode progression transposed around the singer's dominant
    # pitch class. The progression is generated by Drellion, not taken from the reference.
    offsets = [0, -3, 5, -2]
...
def synthesize_instrumental(
    ...
    templates = [_bar_template(bpm, variant, chord, tonic_midi) for chord in range(4)]
    frames_written = 0
    bar_index = 0
